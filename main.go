...
func NewMetricsCollector(uri string, readThresholds map[string]int, writeThresholds map[string]int, defaultReadThreshold int, defaultWriteThreshold int, staticCacheExpiration time.Duration, dynamicCacheExpiration time.Duration, collectionInterval time.Duration, enableLogging bool) (*MetricsCollector, error) {
	...
	mc := &MetricsCollector{
		...
		diskWriteThresholds: prometheus.NewDesc("oie_disk_w_alert_threshold", "Disk write alert threshold", []string{"domain", "instance_uuid", "user_uuid", "project_uuid", "disk_uuid", "disk_type", "disk_path"}, nil),
		diskReadBytes:      prometheus.NewDesc("oie_disk_r_gbytes", "Disk read gigabytes", []string{"domain", "instance_uuid", "user_uuid", "project_uuid", "disk_uuid", "disk_type", "disk_path"}, nil),
		diskWriteBytes:     prometheus.NewDesc("oie_disk_w_gbytes", "Disk write gigabytes", []string{"domain", "instance_uuid", "user_uuid", "project_uuid", "disk_uuid", "disk_type", "disk_path"}, nil),
		diskReadRequests:   prometheus.NewDesc("oie_disk_r_requests", "Disk read requests", []string{"domain", "instance_uuid", "user_uuid", "project_uuid", "disk_uuid", "disk_type", "disk_path"}, nil),
		diskWriteRequests:  prometheus.NewDesc("oie_disk_w_requests", "Disk write requests", []string{"domain", "instance_uuid", "user_uuid", "project_uuid", "disk_uuid", "disk_type", "disk_path"}, nil),
		cpuUsage:           prometheus.NewDesc("oie_cpu_percent", "CPU usage percentage", []string{"domain", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkRxBytes:     prometheus.NewDesc("oie_net_rx_gbytes", "Network receive gigabytes", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkTxBytes:     prometheus.NewDesc("oie_net_tx_gbytes", "Network transmit gigabytes", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkRxPackets:   prometheus.NewDesc("oie_net_rx_pkt_total", "Network receive packets", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkTxPackets:   prometheus.NewDesc("oie_net_tx_pkt_total", "Network transmit packets", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkRxErrors:    prometheus.NewDesc("oie_net_rx_er_total", "Network receive errors", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkTxErrors:    prometheus.NewDesc("oie_net_tx_er_total", "Network transmit errors", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkRxDropped:   prometheus.NewDesc("oie_net_rx_drp_total", "Network receive dropped packets", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
		networkTxDropped:   prometheus.NewDesc("oie_net_tx_drp_total", "Network transmit dropped packets", []string{"domain", "interface", "instance_uuid", "user_uuid", "project_uuid"}, nil),
...
func (mc *MetricsCollector) startCacheCleanup() {
	for {
		...
		if mc.enableLogging {
			log.Println("Performed cache cleanup")
		}
	}
}
...
func (mc *MetricsCollector) collectDomainMetrics(ctx context.Context, domain libvirt.Domain) {
	...
	dynamicCacheKey := fmt.Sprintf("dynamic-%s", instanceUUID)
