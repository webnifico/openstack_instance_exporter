...
func TestBehaviorScanningClassifierBranches(t *testing.T) {
	...
	tests := []struct {
		...
		{"single remote flood", BehaviorFeature{Direction: "outbound", Flows: 200, UnrepliedRatio: .9, UniqueDstPorts: 2, MaxSingleDstPort: 10, MaxSingleRemote: 190, TCPCount: 200, TCPUnrepliedRatio: .9, TCPTopRemoteFlows: 190, TCPTopDstPortFlows: 10}, behaviorAnomalies{}, "outbound_single_remote_flood"},
...
func TestInboundAttackClassifierBranches(t *testing.T) {
	...
	tests := []struct {
		...
		{"single remote flood", BehaviorFeature{Direction: "inbound", Flows: 200, UnrepliedRatio: .9, UniqueDstPorts: 5, MaxSingleDstPort: 10, MaxSingleRemote: 190, TCPCount: 200, TCPUnrepliedRatio: .9, TCPTopRemoteFlows: 190, TCPTopDstPortFlows: 10}, "inbound_single_remote_flood"},
